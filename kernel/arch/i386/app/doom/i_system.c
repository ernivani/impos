...
/* ImposOS: skip POSIX and SDL headers */
#ifndef __impos__
#define __impos__
#endif
...
/* ImposOS: doom_exit_to_shell() does longjmp back to shell */
extern void doom_exit_to_shell(void);
...
void I_Quit (void)
{
    ...
    // ImposOS: return to shell via longjmp
    doom_exit_to_shell();
}
